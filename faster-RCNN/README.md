...
| :-----: | :-----: | :------: | :------: | :------: | :-----: |
| VOC07+12 | [faster_RCNN.pth](https://pan.baidu.com/s/11H6uAtY9Qe1HSIULk8uSGQ?pwd=mizg) | VOC-Test07 | - | - | 64.84
...
2. 数据集的处理   
修改voc_annotation.py里面的annotation_mode=2，运行voc_annotation.py生成根目录下的2007_train.txt和2007_val.txt。data_stats.py可对数据集进行类别的object数量统计
...
img/street.jpg
```
4. 在predict.py里面进行设置可以进行fps测试和video视频检测；在原有repo的基础上修改后可以获得第一阶段的proposal boxes。  
...
注：在此实现中，根据repo(https://github.com/rafaelpadilla/Object-Detection-Metrics)实现了计算和绘制map以及各类别prec\rec curve的功能；详见evaluate.py
